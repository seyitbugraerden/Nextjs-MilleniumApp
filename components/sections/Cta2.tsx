					...
					<div className="row">
						<div className="col-lg-5 pe-lg-0">
							<div className="bg-linear-1 text-center rounded-4 position-relative">
								<img className="rounded-4 border border-2 border-white mb-10 mt-5" src="/assets/imgs/cta-2/img-1.png" alt="Millenium Yazılım" />
								...
								<div className="position-absolute top-0 end-0">
									<img className="flickering" src="/assets/imgs/cta-2/star-2.png" alt="Millenium Yazılım" />
								</div>
								<div className="position-absolute bottom-0 start-0">
									<img className="alltuchtopdown" src="/assets/imgs/cta-2/star-1.png" alt="Millenium Yazılım" />
								</div>
							</div>
						</div>
						<div className="col-lg-6 offset-lg-1 ps-lg-0 pe-lg-5 mt-lg-0 mt-6">
							...
							<div className="row position-relative mt-5 mt-md-0">
								<div className="col-md-6 d-flex align-items-center">
									...
									<div className="ms-3">
										<img className="filter-invert" src="/assets/imgs/cta-2/name-ad.svg" alt="Millenium Yazılım" />
