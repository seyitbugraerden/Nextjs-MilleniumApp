            ...
            <div className="col-lg-4">
              ...
              >
                <div className="card-service bg-white p-6 border rounded-4">
                  ...
                  <p className="mb-6">
                    Separating your work from your home life can improve
                    work-life balance and coworking spaces provide a dedicated
                    place to work
                  </p>
                  <Link
                    href="#"
        ...
        <div className="container position-relative z-2">
          <div className="text-center">
            ...
            <h3 className="ds-3 my-3 fw-regular">
              The Leading{" "}
              <span className=" fw-bold">
                IT Solutions <br className="d-lg-block d-none" /> Company
              </span>{" "}
              For You
            </h3>
          </div>
              ...
              <div className="swiper-wrapper">
                <SwiperSlide className="swiper-slide">
                  <div className="card-service-4 position-relative bg-white p-6 border rounded-3 text-center shadow-1 hover-up mt-2">
                    ...
                    <p className="mb-6">
                      Beauis utter enim amet lacus ornare ullamcorper Praesent
                      neque purus rhoncus.
                    </p>
                    <Link href="#" className="text-primary fs-7 fw-bold">
                      Learm More
      ...
      <section className="section-services-4 position-relative fix section-padding">
        <div className="container position-relative z-2">
                      ...
                      <div className="p-lg-3">
                        ...
                        <div className="d-flex pt-5">
                          ...
                          <div className="ps-5">
                            ...
                            <p>
                              Separating your work from your home <br /> life
                        ...
                        <div className="d-flex">
                          ...
                          <div className="ps-5">
                            <h6>Investment</h6>
                            <p>
                              A business consultant provides expert <br />{" "}
                  ...
                  <div className="row align-items-center rounded-3 bg-white p-5">
                    ...
                    <div className="col-lg-7">
                      <div className="p-lg-3">
                        <h4 className="fw-regular">
                          Build Lasting
                          <span className="fw-bold">Partnerships</span>
                        </h4>
                        <p>
                          We strive to build long-lasting partnerships with our
                          clients, understanding their unique challenges and
                ...
                >
                  <div className="row align-items-center rounded-3 bg-white p-5">
                    ...
                    <div className="col-lg-7">
                      <div className="p-lg-3">
                        <h4 className="fw-regular">
                          Enhance <span className="fw-bold">Operational</span>
                        </h4>
                        <p>
                          We strive to build long-lasting partnerships with our
                          clients, understanding their unique challenges and
                ...
                >
                  <div className="row align-items-center rounded-3 bg-white p-5">
                    ...
                    <div className="col-lg-7">
                      <div className="p-lg-3">
                        <h4 className="fw-regular">
                          Continuous <span className="fw-bold">Evolution</span>
                        </h4>
                        <p>
                          We strive to build long-lasting partnerships with our
                          clients, understanding their unique challenges and
          ...
          <div className="text-center mt-6">
            ...
            <Link
              href="#"
              className="ms-md-3 mt-md-0 mt-3 btn btn-outline-secondary hover-up"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width={24}
