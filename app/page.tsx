        ...
        <div className="container">
          <div className="text-center">
            ...
            <h3
              ...
              data-aos-delay={300}
            >
              Dijital Geleceğinizi Şekillendirmek
            </h3>
            <p data-aos="fade-zoom-in" data-aos-delay={100}>
              Yenilikçi, kullanıcı dostu ve sürdürülebilir çözümlerle dijital
              dönüşüm süreçlerini yönetiyor, <br /> her projede kaliteyi ve
              müşteri memnuniyetini ön planda tutarak geleceğe yön veriyoruz.
            </p>
          </div>
              ...
              >
                <div className="card-service bg-white p-6 border rounded-4">
                  ...
                  <p className="mb-6">
                    ...
                    dijital dünyada başarıya ulaştırmayı hedefliyoruz.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                <div className="card-service bg-white p-6 border rounded-3">
                  ...
                  <p className="mb-6">
                    ...
                    hedeflerinizi gerçeğe dönüştürüyoruz.
                  </p>
                </div>
              </div>
            </div>
              ...
              >
                <div className="card-service bg-white p-6 border rounded-3">
                  ...
                  <p className="mb-6">
                    ...
                    etkili çözümler sunuyoruz. Her projede özgünlük ve değer
              ...
              >
                <div className="card-service bg-white p-6 border rounded-3">
                  ...
                  <p className="mb-6">
                    ...
                    kalarak güvenilir dijital çözümler sunuyoruz.
                    Müşterilerimizle uzun vadeli ve sağlam ilişkiler kuruyoruz.
                  </p>
                </div>
              </div>
            </div>
              ...
              >
                <div className="card-service bg-white p-6 border rounded-3">
                  ...
                  <p className="mb-6">
                    ...
                    dijital dünyada başarıya taşımak için çalışıyoruz. Sizi
                    doğru yolda yönlendiriyor ve hedeflerinize ulaşmanızı
                    sağlıyoruz.
                  </p>
                </div>
              </div>
              ...
              >
                <div className="card-service bg-white p-6 border rounded-3">
                  ...
                  <p className="mb-6">
                    ...
                    daha sağlam bir konuma getiriyoruz. Birlikte hareket ederek,
                    her projede daha güçlü sonuçlar elde ediyoruz.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-6">
              <div className="pe-lg-8 me-lg-auto mb-5 mb-lg-0">
                ...
                <p className="fs-5">
                  ...
                  sağladığımız çözümler hakkında müşterilerimizin yorumlarına
                  göz atın. Her projede daha iyiye ulaşmayı hedefliyoruz ve geri
                  bildirimleriniz, gelişim yolculuğumuzun önemli bir parçasıdır.
                </p>
              </div>
            </div>
            <div className="col-lg-6">
            ...
            <div className="col-lg-4">
              <div className="h-100 bg-primary rounded-4 d-flex align-items-center justify-content-center border position-relative border-5 fix border-white py-5">
                <div className="position-relative z-1 fix">
                  ...
                  <p className="fs-5 text-100-keep mb-0 text-center">
                    Mutlu Müşteriler
                  </p>
                </div>
                <img
          ...
          <div className="row">
            <div className="col-lg-6">
              ...
              <span className="fs-5 fw-medium text-white">
                ...
                <br className="d-none d-lg-block" />
                veya Hızlı Bir Yanıt İçin Formu Doldurun
              </span>
              <div className="d-flex pt-6 pb-3 align-items-center">
                ...
                <div className="ps-5">
                  <h6 className="text-white">Bizi Ziyaret Edin</h6>
              ...
              <div className="d-flex pt-3 pb-3 align-items-center">
                ...
                <div className="ps-5">
                  <h6 className="text-white">Hizmetlerimizi İnceleyin</h6>
                  <p className="text-white mb-0">
                    Her projeye özel yaklaşımlarımızla, markanızı dijital <br />
              ...
              <div className="d-flex pt-3 pb-3 align-items-center">
                ...
                <div className="ps-5">
                  <h6 className="text-white">Bizi Tanıyın</h6>
                  <p className="text-white mb-0">
                    Her projede mükemmelliği yakalayarak, markaların <br />{" "}
                    dijital dünyadaki yolculuklarında onlara liderlik ediyoruz.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-lg-6 ps-lg-0 pt-5 pt-lg-0">
              <div className="position-relative">
                <div className="position-relative z-2 p-3 p-md-5 p-lg-8 rounded-3 bg-primary">
                  <h3 className="text-white">Bir Mesaj bırakın</h3>
                  <p className="text-white">
                    Departmanımız en kısa sürede sizlere dönüş yapacaktır.
                  </p>
                  <form action="#">
