...
const page = ({ params }: { params: any }) => {
  ...
  return (
    <>
      <section className="section-page-header py-10 fix position-relative">
        <div className="container position-relative z-1">
          <div className="text-start">
            <h1 className="title__page">{selectedService?.title}</h1>
            <div className="d-flex">
              ...
              <p className="text-primary mb-0">{selectedService?.title}</p>
            </div>
          </div>
        </div>
        <img
      ...
      <SwiperCards selectedService={selectedService} />
          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="text-start mb-lg-0 mb-5">
                ...
                <h3 className="ds-3 my-3">{selectedService?.about.subTitle}</h3>
      ...
      <HowItWork2 selectedService={selectedService} />
