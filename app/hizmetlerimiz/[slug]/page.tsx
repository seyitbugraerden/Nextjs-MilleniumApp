            ...
            <div className="row pt-lg-150 pt-8 text-center d-none d-md-block">
              <div className="col-lg-10 col mx-lg-auto">
                <p className="text-500">
                  Compatible with all operating systems and browsers in the
                  world
                </p>
                    ...
                    <Link href="#" className="d-flex align-items-start mb-6">
                      ...
                      <div className="ms-3 pb-4 border-bottom">
                        ...
                        <p className="text-white mb-0">
                          Our company exists to help merchants sell more. We
                          make every decision and measure every outcome based on
                          how well it serves our customers.
                        </p>
                      </div>
                    </Link>
                  </li>
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-4 col-md-6 mb-lg-0 mb-8 position-relative z-1">
                ...
                <h2 className=" mt-3 mb-4 fw-black">
                  ...
                  <li>
                    ...
                    >
                      <img
                        ...
                        alt="infinia"
                      />
                      <p className=" mb-0 ms-2 fs-5 text-900">
              ...
              <div className="col-lg-4 col-md-6 mb-lg-0 mb-8">
                <div className="position-relative d-inline-block z-2">
                  <img
                    className="rounded-4 border border-3 border-white"
                  ...
                  <div className="position-absolute bottom-0 start-0 end-0 mb-3 mx-3 backdrop-filter rounded-3 text-start p-3">
                    ...
                    >
                      ...
                      />
                      <span className="ms-3">
                        <span className="text-white text-uppercase mb-0 fs-7">
                          Contact Us
                        </span>
              ...
              <div className="col-lg-4 mb-lg-0 mb-8">
                <div className="px-lg-8">
                  <div className="d-flex align-items-center border-bottom pb-5 mt-5">
                    <span className="h2 count fw-black ">
                      <span className="odometer" />{" "}
                      <CountUp end={99} enableScrollSpy={true} />
                    </span>
          ...
          <div className="row">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="feature-item mb-5 position-relative mb-lg-0 bg-white p-5 rounded-4 hover-up">
                ...
                <p>
                  We ensure your transactions are safe with advanced encryption
            ...
            <div className="col-lg-3 col-md-6">
              <div className="feature-item mb-5 position-relative mb-lg-0 bg-white p-5 rounded-4 hover-up">
                ...
                <h6>Save Money</h6>
                <p>
                  Enjoy competitive pricing, exclusive discounts, promotions to
            ...
            <div className="col-lg-3 col-md-6">
              <div className="feature-item mb-5 position-relative mb-lg-0 bg-white p-5 rounded-4 hover-up">
                ...
                <h6>Quick Support</h6>
                <p>
                  Our dedicated support team offers prompt assistance through
            ...
            <div className="row">
              <div className="col-lg-5 position-relative">
                ...
                <h5 className="ds-5 mt-2">
                  Optimize Your <br /> Finances with Ease.
                </h5>
                <div className="d-flex pt-3 align-items-center">
                  ...
                  <div className="ps-5">
                    <h6>Our History</h6>
                    <p>
                      A Journey of Innovation, Growth, <br /> and Technological
                      Advancement
                    </p>
                  </div>
                </div>
                <div className="d-flex pt-3 align-items-center">
                  ...
                  <div className="ps-5">
                    <h6>Our Mission</h6>
                    <p>
                      Empowering Your Digital Success Through <br /> Innovative
                      Solutions
                    </p>
                  </div>
                </div>
                <div className="d-flex pt-3 align-items-center">
                  ...
                  <div className="ps-5">
                    <h6>Our Vision</h6>
                    <p>
                      Leading the Future of Web Development <br /> with
        ...
        <div className="container">
          <div className="text-center">
            ...
            <p className="fs-5 pb-4">
              We break down barriers so teams can focus on what matters –
              working together <br className="d-none d-lg-block" />
