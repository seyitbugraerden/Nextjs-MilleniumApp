        ...
        <div className="container position-relative z-1">
          <div className="text-center">
            <h5 className="ds-5 mt-3 mb-3">
              Bir proje mi düşünüyorsunuz? <br className="d-md-block d-none" />
              Bizimle iletişime geçin.
            </h5>
            <span className="fs-5 fw-medium">
              Aşağıdaki Ayrıntılar aracılığıyla Bugün Bizimle Bağlantı Kurun
              <br className="d-md-block d-none" /> veya Hızlı Bir Yanıt İçin
              Formu Doldurun
            </span>
          </div>
              ...
              <div className="row">
                ...
                <div className="col-lg-6">
                  <div className="ps-lg-6">
                    <h6>Bizimle sohbet edin</h6>
                    <p className="text-500">
                      Destek ekibi her zaman 7/24 hizmetinizdedir
                    </p>
                    ...
                    <h6>Bize bir e-posta gönderin</h6>
                    <p className="text-500">
                      Ekibimiz sorularınıza derhal yanıt verecektir
                    </p>
                    <div className="d-flex mb-2">
                      <img
